...
pin_length = 26;  // 这个只能在真实长度上增加 0.5mm
pin_row_matrix = [
    [-25/2, -(box_length - pin_length)/2 + 4.8, pin_length],
    [ 25/2, -(box_length - pin_length)/2 + 4.8, pin_length]
];
// 每排排针开槽的宽度，单位 mm。
// pin_slot_width = 2.8;
...
vent_auto_fill = true;       // [true,false]
// 蜂窝区域中心位置 [X, Y]，单位 mm。
vent_center = [0, 10];
